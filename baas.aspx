<%@ Page Title="RainDrive | Backup as a Service" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" %>
    ...
    <%@ Register Src="~/seo/seo-common.ascx" TagPrefix="uc" TagName="Seo" %>
        ...
        <asp:Content ID="Head" ContentPlaceHolderID="HeadContent" runat="server">
            ...
            <uc:Seo />
            <script>
                document.body.setAttribute("data-page", "baas.aspx");
            </script>
        </asp:Content>
                    ...
                    <div class="container two-col it-intro">
                        <div class="it-content">
                            ...
                            <p class="section-subtitle">
                                ...
                                and managing them end-to-end—so your data is always secure, compliant, and ready to
                                recover.
                            </p>
                        ...
                        <div class="it-highlights">
                            <div class="highlight-item">
                                ...
                                <span><strong>End-to-End Managed Service</strong><br />
                                    From assessment to daily operations, our engineers manage the entire backup
                                    lifecycle,
                            ...
                            <div class="highlight-item">
                                ...
                                <span><strong>Always-On, Automated Backups</strong><br />
                                    Continuous, automated backups run in the background without impacting business
                                    performance.
                                </span>
                            </div>
                            ...
                            <div class="highlight-item">
                                ...
                                <span><strong>Secure & Encrypted Data Protection</strong><br />
                                    Data is encrypted in transit and at rest, protecting against ransomware, cyber
                                    threats,
                            ...
                            <div class="highlight-item">
                                ...
                                <span><strong>24×7 Monitoring & Proactive Alerts</strong><br />
                                    Continuous monitoring of backup jobs and storage health, with issues resolved before
                                    impact.
                                </span>
                            </div>
                            ...
                            <div class="highlight-item">
                                ...
                                <span><strong>SLA-Driven Recovery</strong><br />
                                    Clearly defined RPOs and RTOs ensure predictable and fast recovery during
                                    disruptions.
                                </span>
                            </div>
                            ...
                            <div class="highlight-item">
                                ...
                                <span><strong>Compliance & Audit Readiness</strong><br />
                                    Enterprise-aligned retention policies, reporting, and governance-ready backup
                                    controls.
                                </span>
                            </div>
                        </div>
...
========================== -->
            <section class="container baas-section glass-card">
                ...
                <div class="baas-grid">
                    ...
                    <div class="baas-card">
                        ...
                        <p>
                            Custom-designed backup strategies aligned with business objectives, compliance, and recovery
                            goals.
                        </p>
                    </div>
                    ...
                    <div class="baas-card">
                        ...
                        <p>
                            Regular verification with clear, audit-ready reports on backup health and recovery
                            readiness.
                        </p>
                    </div>
                    ...
                    <div class="baas-card">
                        ...
                        <p>
                            Encrypted, immutable, and policy-driven retention meeting security and compliance
                            requirements.
                        </p>
                    </div>
